package br.edu.ifsp.scl.ads.pdm.aulas.sendmail
...
import br.edu.ifsp.scl.ads.pdm.aulas.sendmail.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        amb.cleanBt.setOnClickListener { view ->
            with(amb){
                toEt.setText("")
                ccEt.setText("")
                bccEt.setText("")
